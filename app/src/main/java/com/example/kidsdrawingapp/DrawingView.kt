...
class DrawingView(context: Context, attrs:AttributeSet) :View(context,attrs) {
    ...
    private var mCanvasBitmap:Bitmap?=null //an instance of bitmap
     //the paint class holds the style and color information about how to draw geometries,text and bitmap
     private var mDrawPaint:Paint?=null
    private var mCanvasPaint:Paint?=null //instance of canvas paint view
    private var mBrushSize:Float=0.toFloat()
    private var color= Color.BLACK
    //using canvas for white background
